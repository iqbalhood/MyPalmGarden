...
public class Home2Activity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                viewHolder.setOnClickListener(new  MovieViewHolder.ClickListener() {
                    ...
                    public void onItemClick(View view, int position) {
                        ...
                        if (!(viewHolder.iv_id.getText().toString().isEmpty())) {
                            ...
                            Intent k = new Intent(Home2Activity.this, ListJawaban.class);
        ...
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(Home2Activity.this, LinearLayoutManager.VERTICAL, false);
...
//                alertDialog.show();
                ...
                Intent question = new Intent(Home2Activity.this, CreateQuestion.class);
...
//    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.navigation_map) {
            Intent pindah = new Intent(Home2Activity.this, PeopleMap.class);
            startActivity(pindah);
            // Handle the camera action
        } else if (id == R.id.navigation_search) {
            Intent pindah = new Intent(Home2Activity.this, SearchActivity.class);
            startActivity(pindah);

        } else if (id == R.id.navigation_download) {
            Intent pindah = new Intent(Home2Activity.this, DownloadFilesActivity.class);
            startActivity(pindah);

        } else if (id == R.id.navigation_profile) {

            Intent pindah = new Intent(Home2Activity.this, EditProfileActivity.class);
            startActivity(pindah);
    ...
    public void signOut() {
        mAuth.signOut();
        Intent pindah = new Intent(Home2Activity.this, LoginActivity.class);
        startActivity(pindah);
    }
}
