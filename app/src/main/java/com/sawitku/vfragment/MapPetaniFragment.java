...
public class MapPetaniFragment extends Fragment implements
    ...
    public static MapPetaniFragment newInstance() {
        MapPetaniFragment fragment = new MapPetaniFragment();
        return fragment;
    }
                    ...
                    public void onDataChange(DataSnapshot snapshot) {
                        ...
                        for (DataSnapshot singleSnapshot : snapshot.getChildren()) {
                            ...
                            if (singleSnapshot.child("lat").exists() && singleSnapshot.child("tipe").exists()) {
                                ...
                                if(singleSnapshot.child("tipe").getValue().toString().contains("1")) {
                                    ...
                                    if (str != null && !str.isEmpty()) {
                                        ...
                                        googleMap.addMarker(new MarkerOptions().position(sydney).icon(getMarkerIcon("#FFC107")));
...
//                googleMap.animateCamera(CameraUpdateFactory.newCameraPosition(cameraPosition));
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ft.detach(MapPetaniFragment.this).attach(MapPetaniFragment.this).commit();
