...
public class MapPraktisiFragment extends Fragment implements
    ...
    public static MapPraktisiFragment newInstance() {
        MapPraktisiFragment fragment = new MapPraktisiFragment();
        return fragment;
    }
                    ...
                    public void onDataChange(DataSnapshot snapshot) {
                        ...
                        for (DataSnapshot singleSnapshot : snapshot.getChildren()) {
                            ...
                            if (singleSnapshot.child("lat").exists() && singleSnapshot.child("tipe").exists()) {
                                ...
                                if(singleSnapshot.child("tipe").getValue().toString().contains("3")) {
...
//                googleMap.animateCamera(CameraUpdateFactory.newCameraPosition(cameraPosition));
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ft.detach(MapPraktisiFragment.this).attach(MapPraktisiFragment.this).commit();
