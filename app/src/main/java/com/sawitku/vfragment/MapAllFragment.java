...
public class MapAllFragment extends Fragment implements
    ...
    public static MapAllFragment newInstance() {
        MapAllFragment fragment = new MapAllFragment();
        return fragment;
    }
                ...
                qry.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot snapshot) {
                        ...
                        for (DataSnapshot singleSnapshot : snapshot.getChildren()) {
                            ...
                            if (singleSnapshot.child("lat").exists() && singleSnapshot.child("log").exists() && singleSnapshot.child("tipe").exists() ) {
                                ...
                                if(str != null && !str.isEmpty()) {
                                    ...
                                    if(tipe.contains("1")){
                                        googleMap.addMarker(new MarkerOptions().position(sydney).icon(getMarkerIcon("#FF5722")));

                                    }else if(tipe.contains("2")) {
                                        googleMap.addMarker(new MarkerOptions().position(sydney).icon(getMarkerIcon("#FF5722")));


                                    }else if(tipe.contains("3")) {
                                        googleMap.addMarker(new MarkerOptions().position(sydney).icon(getMarkerIcon("#42A5F5")));
...
//                googleMap.animateCamera(CameraUpdateFactory.newCameraPosition(cameraPosition));
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ft.detach(MapAllFragment.this).attach(MapAllFragment.this).commit();
